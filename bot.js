    ...
    await page.evaluateOnNewDocument(() => {
        ...
        window.addEventListener('load', () => {
            setTimeout(() => {
                ...
                let positionAttempts = {}; // V35.0: Reinstated Position Blacklist
                ...
                ui.innerHTML = `
                    <div style="font-weight: bold; font-size: 13px; color: #ffeb3b; margin-bottom: 5px;">⚡ Infinite Bot v35.0</div>
                ...
                // V35.0 BATTING POSITION CLICKER: Instantly skips greyed out numbers
                    ...
                    for (let i = modalElements.length - 1; i >= 0; i--) {
                        ...
                        if (text === targetNumber.toString()) {
                            ...
                            if (rect.width > 0 && rect.height > 0 && style.display !== 'none') {
                                // V35 FIX: Instantly reject disabled positions inside the popup
                                if (isRowDisabled(el)) continue; 
                ...
                function resetDraftState() {
                    ...
                    failedPlayerClicks = {};
                    positionAttempts = {}; // Clear position attempts on reset
                }

                log("Bot injected. Spatial Isolation v35.0 active!");
                ...
                setInterval(() => {
                    ...
                    // STEP 4: BATTING POSITION POPUP (V35.0 FIX)
                    ...
                    if (smartClick("spin", true, false)) {
                        ...
                        blacklistedPlayers.clear();
                        failedPlayerClicks = {};
                        positionAttempts = {}; // Clear position attempts on new spin
